...
{{cookiecutter.repo_name}}.src.config
import logging as logging_setup

from client import Client
from nodes import data_gathering, data_preparation, data_storage, data_transform, data_viz
...
if __name__ == '__main__':
    # Setup logging based on logging.ini. This configures the root logger.
    logging_setup.setup()
